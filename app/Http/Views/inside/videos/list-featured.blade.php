...
<ol class="breadcrumb">
    ...
    <li class="active">Danh sách Video nổi bật</li>
</ol>
...
<div id="page-content">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Danh sách Video nổi bật</h3>
        </div>
        <div class="panel-body">
            ...
            <div id="table-toolbar">
                ...
                <button id="demo-featured-row" class="btn btn-success btn-labeled fa fa-times" disabled>Bỏ nổi bật</button>
                <a href="{!! url("/{$moduleName}/{$controllerName}/add") !!}" class="btn btn-primary btn-labeled fa fa-plus">Thêm</a>
            </div>
            <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
                    data-locale="vi-VN"
                    data-toolbar="#table-toolbar"
                    data-url="{!! url("/{$moduleName}/{$controllerName}/ajax-data-featured") !!}"
                    data-search="true"
