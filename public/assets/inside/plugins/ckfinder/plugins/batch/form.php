<div style=\"padding: 20px \"> 
    ...
    <form action='/assets/inside/plugins/ckfinder/core/connector/php/connector.php?command=FileUpload&type=<?= $_GET['type'] ?>&currentFolder=<?= $_GET['currentFolder'] ?>' method='post' enctype='multipart/form-data'> 
    ...
    <div>&nbsp; &nbsp; Uploading multiple large files may take several minutes.<br />
        ...
        &nbsp; &nbsp; view other <a href="?<?= rand(1, 99999) ?>" onClick="document.getElementById('restrictions').style.display = 'block';
                return false">configuration restrictions</a>.	
    </div>
